          ...
          <ContentStyle>
            ...
            <m.div variants={varFade().inRight}>
              <Typography sx={{ color: 'common.white' }}>
                Descubra uma maneira única e emocionante de celebrar o amor! Apresentamos [Nome do
                Produto], a plataforma perfeita para transformar presentes de casamento em momentos
                memoráveis.
              </Typography>
            </m.div>
